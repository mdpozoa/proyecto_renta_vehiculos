...
const MODULE_NAME = 'Marca';

const fields = [
  { key: 'ID_Marca',     label: 'ID Marca', type: 'number', readOnly: true },
  { key: 'Nombre_Marca', label: 'Nombre',   type: 'text',   required: true },
];
...
<template>
  <div class="crud-view">
    <div class="page-header">
      <h1 class="page-title text-primary">Módulo Marcas</h1>
      <p class="text-muted">Gestiona las marcas de vehículos.</p>
    </div>
    <div style="display:flex; justify-content:flex-end; margin-bottom:2rem;">
      <button @click="openCreate" class="btn-primary" style="padding:0.75rem 2rem; display:flex; align-items:center; gap:0.5rem;">
        <span style="font-size:1.25rem;">+</span> Nueva Marca
      </button>
    </div>
