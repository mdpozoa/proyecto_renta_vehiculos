...
const PK = 'ID_Auditoria';
const ENDPOINT = '/Auditorias';
const MODULE_NAME = 'Auditoría';

const fields = [
  { key: 'ID_Auditoria',    label: 'ID Auditoría',  type: 'number', readOnly: true },
  { key: 'ID_Usuario',      label: 'ID Usuario',    type: 'number', required: true },
  { key: 'Accion_Auditoria',label: 'Acción',        type: 'textarea', required: true, fullWidth: true },
  { key: 'Fecha_Auditoria', label: 'Fecha',         type: 'datetime', readOnly: true },
];
...
<template>
  <div class="crud-view">
    <div class="page-header">
      <h1 class="page-title text-primary">Módulo Auditorías</h1>
      <p class="text-muted">Registro de acciones del sistema.</p>
    </div>
    <div style="display:flex; justify-content:flex-end; margin-bottom:2rem;">
      <button @click="openCreate" class="btn-primary" style="padding:0.75rem 2rem; display:flex; align-items:center; gap:0.5rem;">
        <span style="font-size:1.25rem;">+</span> Nueva Auditoría
      </button>
    </div>
    <div class="glass-panel" style="padding:0; overflow:hidden;">
      ...
      <div v-else style="padding:4rem; text-align:center;"><h3 class="text-muted">La tabla está vacía</h3></div>
    </div>
