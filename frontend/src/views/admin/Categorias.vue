...
const MODULE_NAME = 'Categoría';

const fields = [
  { key: 'ID_Categoria',       label: 'ID Categoría',  type: 'number',   readOnly: true },
  { key: 'Nombre_Categoria',   label: 'Nombre',         type: 'text',     required: true },
  { key: 'Descripcion_Categoria', label: 'Descripción', type: 'textarea', required: false, fullWidth: true },
];
...
<template>
  <div class="crud-view">
    <div class="page-header">
      <h1 class="page-title text-primary">Módulo Categorías</h1>
      <p class="text-muted">Gestiona las categorías de vehículos.</p>
    </div>
    <div style="display:flex; justify-content:flex-end; margin-bottom:2rem;">
      <button @click="openCreate" class="btn-primary" style="padding:0.75rem 2rem; display:flex; align-items:center; gap:0.5rem;">
        <span style="font-size:1.25rem;">+</span> Nueva Categoría
      </button>
    </div>
